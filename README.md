# Description
This repository provides the official implimentation of the illuminant estimation algorithm **BoCF** proposed in paper *[Bag of Color Features For Color Constancy](https://ieeexplore.ieee.org/document/9130881)* accepted in *IEEE Transactions on Image Processing (TIP)*  using *[INTEL-TAU dataset](https://ieeexplore.ieee.org/document/9371681)*. 
